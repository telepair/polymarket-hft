...
│                                                                              │
│  ┌─────────────┐  ┌─────────────┐  ┌─────────────┐  ┌─────────────┐         │
│  │ Data Client │  │ CLOB Client │  │Gamma Client │  │ RTDS Client │         │
...
Multi-source client architecture under `src/client/`. Currently implements Polymarket APIs with extensibility for future data sources. See [Library Guide](./library.md) for usage details.
