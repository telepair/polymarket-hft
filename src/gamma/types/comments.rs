//! Comment representations for the Gamma API.
use serde::{Deserialize, Serialize};
use url::Url;

use super::events::OptimizedImage;
use super::helpers::deserialize_option_u64;
...
impl<'a> GetCommentsRequest<'a> {
    ...
    pub fn validate(&self) -> Result<()> {
        super::helpers::validate_comment_parent(self.parent_entity_type, self.parent_entity_id)?;
        Ok(())
    }
